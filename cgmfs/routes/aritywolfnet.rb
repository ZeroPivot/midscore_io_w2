class CGMFS
  hash_branch 'aritywolfnet' do |r| # ss: screenshot
    r.hash_branches
    r.is do
      r.get do
        log('-------------------')
        log('Aritywolf.net -> Deviantart.com/ArityWolf Redirection Request:', filename: 'aritywolf_redir.txt')
        ...
        if DO_TELEGRAM_LOGGING
          @@telegram_logger.send_message("[HTTPRequestRelay(aritywolfnet)]:
