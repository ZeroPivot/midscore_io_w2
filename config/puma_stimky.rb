...
#
pidfile '/root/midscore_io/config/puma.pid'

# Use "path" as the file to store the server info state. This is
# used by "pumactl" to query and control the server.
#
state_path '/root/midscore_io/config/puma.state'

# Redirect STDOUT and STDERR to files specified. The 3rd parameter
# ("append") specifies whether the output is appended, the default is
# "false".
#
stdout_redirect '/root/midscore_io/log/stdout', '/root/midscore_io/log/stderr', true
...
#
restart_command '/root/midscore_io/restart_puma'
...
rackup '/root/midscore_io/config.ru'
